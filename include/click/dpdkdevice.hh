...
#define SLEEP_POLICY_SIMPLE 256
#define SLEEP_RTE 512
#define SLEEP_HR2 1024
#define SLEEP_POLICY_ACTUALLYPOWER 2048
#define SLEEP_POLICY_MONITOR 4096
#define SLEEP_POLICY_TUPE 8192
#define SLEEP_POLICY_SLOTH 16384
#define SLEEP_RTE_PAUSE 32768
#define SLEEP_POLICY_DUNEISH 65536

// #define PMD_MGMT RTE_POWER_MGMT_TYPE_MONITOR
// #define PMD_MGMT RTE_POWER_MGMT_TYPE_PAUSE
// #define PMD_MGMT RTE_POWER_MGMT_TYPE_SCALE
...
public:
    ...
    struct DevInfo {
        inline DevInfo() :
            ...
            lro(false), jumbo(false),sleep_mode(0),power_max_empty_poll(0),power_pause_duration(0)
        ...
        uint32_t sleep_mode;
        uint16_t power_pause_duration;
        uint16_t power_max_empty_poll;
    };
